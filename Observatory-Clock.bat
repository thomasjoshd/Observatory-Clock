...
rem Edit the anaconda path if necessary below
rem Edit the line "python c:\Observatory-Clock\Observatory-Clock.py" below
...
python c:\Observatory-Clock\Observatory-Clock.py
